...
//   String baseUrl = "https://twitchgoserver.herokuapp.com";
//   String? token;
...
//         widget.channelId) {
//       await FirestoreController().endLiveStream(widget.channelId);
//     } else {
//       await FirestoreController().updateViewCount(widget.channelId, false);
//     }
...
//             }))
//         .catchError((onError) => debugPrint("SwitchCamera Error: $onError"));
//   }
...
//   //   _engine.muteLocalVideoStream(isVideoMute).then((value) =>  setState(() {
